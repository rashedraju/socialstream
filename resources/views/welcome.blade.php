        ...
        <div class="col-md-8 offset-md-2">
            <div class="status shadow-sm" class="">
                <div class="row p-3 pb-2">
                    <div class="col-md-2">
                        <img style="width:50px;" src="{{ empty($status->user->avatar) ? asset('images/profile/avatar.jpg') : $status->user->avatar }}" class="mt-3 rounded-circle img-thumbnail mx-auto d-block" alt="profile picture">
                    </div>
